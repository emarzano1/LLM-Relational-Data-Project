...
This project was developed for the assignment of the course Models and Practice of Neural Table Representations". The goal is to compare two different paradigms for querying relational data using Large Language Models (LLMs):
